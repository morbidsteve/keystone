...
export const ECHELON_COLORS: Record<string, string> = {
  HQMC: 'bg-slate-600 text-white',
  [Echelon.MEF]: 'bg-blue-600 text-white',
  [Echelon.DIVISION]: 'bg-indigo-600 text-white',
  DIV: 'bg-indigo-600 text-white',
  WING: 'bg-sky-600 text-white',
  GRP: 'bg-violet-600 text-white',
  [Echelon.REGIMENT]: 'bg-purple-600 text-white',
  REGT: 'bg-purple-600 text-white',
  [Echelon.BATTALION]: 'bg-green-600 text-white',
  BN: 'bg-green-600 text-white',
  SQDN: 'bg-cyan-600 text-white',
  [Echelon.COMPANY]: 'bg-amber-600 text-white',
  CO: 'bg-amber-600 text-white',
  [Echelon.PLATOON]: 'bg-yellow-600 text-black',
  PLT: 'bg-yellow-600 text-black',
  [Echelon.SQUAD]: 'bg-orange-600 text-white',
  SQD: 'bg-orange-600 text-white',
  [Echelon.FIRE_TEAM]: 'bg-red-600 text-white',
  FT: 'bg-red-600 text-white',
  [Echelon.INDIVIDUAL]: 'bg-gray-500 text-white',
  INDV: 'bg-gray-500 text-white',
  [Echelon.CUSTOM]: 'bg-gray-400 text-white',
};
